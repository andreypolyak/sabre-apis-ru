...
{{< details title="**Обновление от 26.05.2012**" open=true >}}
В разделе [Тайм-лимиты бронирований](timelimit.html) добавлены регулярные выражения для парсинга тайм-лимитов в SSR сообщениях перевозчиков.
