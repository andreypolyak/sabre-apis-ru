...
![](/sabre-apis-ru/assets/svg/queues/queues[get].svg)
...
![](/sabre-apis-ru/assets/svg/queues/queues[PNR].svg)
...
Текущее открытое бронирование можно изменить. См. [Редактирование бронирований](edit-booking.html), [Оформление билетов и EMD](issue-ticket.html), [Отмена бронирований](cancel-booking.html), [Войдирование билетов и EMD](void-ticket.html), [Вынужденный обмен билетов](involuntary-exchange-ticket.html), а также подразделы ниже.

#### Обработка изменений в расписании (очереди 5 и 6)

При обработке очередей с номером 5 (перевозчик сообщил об изменении расписания, вылет в ближайшие 17 дней) и 6 (перевозчик сообщил об изменении расписания, вылет более чем через 17 дней) рекомендуется [принять изменения в расписании и выполнить вынужденный обмен билетов](involuntary-exchange-ticket.html). 
...
При обработке очередей 0 (перевозчик прислал сообщение или подтверждение услуги, вылет в течение 24 часов) и 1 (перевозчик прислал сообщение или подтверждение услуги, вылет более чем через 24 часа) можно получить сообщения перевозчика о тайм-лимите. См. [Тайм-лимиты бронирований](timelimit.html).
