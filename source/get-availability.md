# Поиск по расписаниям и получение данных о наличии мест
...
{% xmlsec "Пример запроса (простой запрос, последовательность дат)", false %}
<AirSchedulesAndAvailabilityRQ version="5.3.1" xmlns="https://myschedules.havail.sabre.com/ws/AirSchedulesAndAvailability">
...
{% xmlsec "Пример запроса (белый список маркетинговых перевозчиков)", false %}
<AirSchedulesAndAvailabilityRQ version="5.3.1" xmlns="https://myschedules.havail.sabre.com/ws/AirSchedulesAndAvailability">
  <OriginDestination date="2020-09-20" destination="NYC" identifier="1" origin="MOW">
    <Options>
...
{% xmlsec "Пример запроса (черный список оперирующих перевозчиков)", false %}
<AirSchedulesAndAvailabilityRQ version="5.3.1" xmlns="https://myschedules.havail.sabre.com/ws/AirSchedulesAndAvailability">
  <OriginDestination date="2020-09-20" destination="NYC" identifier="1" origin="MOW">
    <Options>
...
{% xmlsec "Пример запроса (исключение интерлайн перелетов)", false %}
<AirSchedulesAndAvailabilityRQ version="5.3.1" xmlns="https://myschedules.havail.sabre.com/ws/AirSchedulesAndAvailability">
  <OriginDestination date="2020-09-20" destination="NYC" identifier="1" origin="MOW">
    <Options>
...
{% xmlsec "Пример запроса (без пересадок)", false %}
<AirSchedulesAndAvailabilityRQ version="5.3.1" xmlns="https://myschedules.havail.sabre.com/ws/AirSchedulesAndAvailability">
  <OriginDestination date="2020-09-20" destination="NYC" identifier="1" origin="MOW">
    <Options>
...
{% xmlsec "Пример запроса (одна пересадка в любом из пунктов)", false %}
<AirSchedulesAndAvailabilityRQ version="5.3.1" xmlns="https://myschedules.havail.sabre.com/ws/AirSchedulesAndAvailability">
  <OriginDestination date="2020-09-20" destination="NYC" identifier="1" origin="MOW">
    <Options>
      <Routing>
...
{% xmlsec "Пример запроса (две пересадки)", false %}
<AirSchedulesAndAvailabilityRQ version="5.3.1" xmlns="https://myschedules.havail.sabre.com/ws/AirSchedulesAndAvailability">
  <OriginDestination date="2020-09-20" destination="NYC" identifier="1" origin="MOW">
    <Options>
      <Routing>
...
{% xmlsec "Пример запроса (исключение пересадок в городах и странах)", false %}
<AirSchedulesAndAvailabilityRQ version="5.3.1" xmlns="https://myschedules.havail.sabre.com/ws/AirSchedulesAndAvailability">
  <OriginDestination date="2020-09-20" destination="NYC" identifier="1" origin="MOW">
    <Options>
      <Routing>
...
{% xmlsec "Пример запроса (выбор диапазона рейсов)", false %}
<AirSchedulesAndAvailabilityRQ version="5.3.1" xmlns="https://myschedules.havail.sabre.com/ws/AirSchedulesAndAvailability">
  <OriginDestination date="2020-09-20" destination="NYC" identifier="1" origin="MOW">
    <Options>
      <Routing>
...
{% xmlsec "Пример запроса (выбор конкретных рейсов)", false %}
<AirSchedulesAndAvailabilityRQ version="5.3.1" xmlns="https://myschedules.havail.sabre.com/ws/AirSchedulesAndAvailability">
  <OriginDestination date="2020-09-20" destination="NYC" identifier="1" origin="MOW">
    <Options>
      <Routing>
...
{% xmlsec "Пример запроса (отправление с 10:00 до 18:00)", false %}
<AirSchedulesAndAvailabilityRQ version="5.3.1" xmlns="https://myschedules.havail.sabre.com/ws/AirSchedulesAndAvailability">
...
{% xmlsec "Пример запроса (прибытие с 10:00 до 18:00)", false %}
<AirSchedulesAndAvailabilityRQ version="5.3.1" xmlns="https://myschedules.havail.sabre.com/ws/AirSchedulesAndAvailability">
...
По умолчанию сервис возвращает до 8 вариантов перелетов для каждой заданной комбинации направления и даты отправления или прибытия. Это значение можно увеличить (максимум 300), указав нужное значение у атрибута ```/AirSchedulesAndAvailabilityRQ/OriginDestination/Options/@maxReturnedOptions```. В режиме поиска по последовательности дат можно установить количество возвращаемых вариантов перелетов в качестве значения атрибута ```/AirSchedulesAndAvailabilityRQ/Calendar/Options/@solutionsPerDay``` (максимум 50).

{% xmlsec "Пример запроса (1 вариант перелета)", false %}
<AirSchedulesAndAvailabilityRQ version="5.3.1" xmlns="https://myschedules.havail.sabre.com/ws/AirSchedulesAndAvailability">
  <OriginDestination date="2020-09-20" destination="NYC" identifier="1" origin="MOW">
...
{% xmlsec "Пример запроса (только расписания рейсов)", false %}
<AirSchedulesAndAvailabilityRQ version="5.3.1" xmlns="https://myschedules.havail.sabre.com/ws/AirSchedulesAndAvailability">
  <OriginDestination date="2020-09-20" destination="NYC" identifier="1" origin="MOW">
